...
Filters.sharpen = function (pixels) {
    pixels = this.filterImage(this.convolute, pixels,
        [0, -1, 0,
            -1, 5, -1,
            0, -1, 0]
    )
...
Filters.sharpenExtra = function (pixels) {
    pixels = this.filterImage(this.convolute, pixels,
        [-1, 0, -1,
        -1, 7, -1,
        -1, 0, -1]
...
Filters.sharpenTest = function (pixels) {
    pixels = this.filterImage(this.convolute, pixels,
        [-1, 0, -1,
            0, 5, 0,
        -1, 0, -1]
...
Filters.autolvl = function (pixels) {
    var redMax = 0;
    var redMin = 255;
    var greenMax = 0;
    var greenMin = 255;
...
Filters.autolvlGrayInvert = function (pixels) {
    var redMax = 0;
    var redMin = 255;
    var greenMax = 0;
    var greenMin = 255;
